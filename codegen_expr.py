...
class CodeGen:
    ...
    def gen_file_header(self) -> None:
        ...
        self.emit("; ---------------------------------------------------------------------------")
        self.emit("; ---------------------------------------------------------------------------")
        self.emit(".FEATURE\tdollar_in_identifiers")
        self.emit("")
        ...
        if field_info.array_sizes:
            ...
            if expr.is_deref:
                ...
                if field_offset > 0:
                    ...
                    carry_lbl = self.new_label("NOCARRY_ARRFIELD_DEREF")
                ...
                if isinstance(expr.object, Identifier):
                    ...
                    if field_offset > 0:
                        ...
                        carry_lbl = self.new_label("NOCARRY_ARRFIELD_SUBSCR")
                        self.emit(f"\tBCC {carry_lbl}")
    ...
    def gen_assign(self, lhs: Expr, rhs: Expr) -> None:
        ...
        if (rhs_t.sem_type.base == "BYTE" and not rhs_t.sem_type.is_pointer and
            ...
            self.emit("\tLDX #$00")  # Clear X for BYTE to WORD conversion

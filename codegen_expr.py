...
class CodeGen:
    ...
    def __init__(self, symtab: SymbolTable, type_checker: ExprTypeChecker, *, is_65c02: bool = True, used_globals: set[str] | None = None, debug_info: dict | None = None):
    ...
    def gen_file_header(self):
        ...
        target = "WDC65c02" if self.is_65c02 else "6502"
        self.emit(f"; Target: {target} Assembly")
        self.emit("; ------------------------------\n")

...
/*
    getc	    read a character from the keyboard (alias for getchar)
    #fixme: this is just an alias for getchar for now, but could be extended to support file input in the future
*/
func byte getc()
    return getchar()
end

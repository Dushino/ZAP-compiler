...
; Command: /usr/bin/python3 compiler.py tests/pass/046-control-flow-if-else/046-control-flow-if-else.zap -o tests/pass/046-control-flow-if-else/046-control-flow-if-else_default.s
; ==============================

...
; Command: /usr/bin/python3 compiler.py -O1 tests/pass/046-control-flow-if-else/046-control-flow-if-else.zap -o tests/pass/046-control-flow-if-else/046-control-flow-if-else_O1.s
; ==============================
